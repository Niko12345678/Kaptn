...
require_once 'class/class.Strings.php';
require_once 'class/class.Feed.php';
require_once 'class/class.FeedEntry.php';

$feed_title   = 'KAPTN';
$feed_link    = 'http://kaptn.altervista.org/feed.php';
$description  = '';
